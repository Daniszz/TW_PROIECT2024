    ...
    fetch('get_photos.php')
        ...
        .then(data => {
            ...
            data.forEach(photo => {
                ...
                <img src=${photo.link} class="masterSection__post__image">
                ...
                <div class="masterSection__post__results">
                    ...
                    <button disabled class="masterSection__post__results__comments">${photo.comments}</button>
                    <button disabled class="masterSection__post__results__shares">${photo.shares}</button>
                </div>
                `;
